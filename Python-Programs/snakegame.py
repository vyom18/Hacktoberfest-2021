...
if init_status[1] > 0:
    ...
    print("(+) The game initialised successfully ")
...
while True:
    ...
    if foodSpawn == False:
        foodPos = [
            random.randrange(1, width // 10) * delta,
            random.randrange(1, height // 10) * delta,
        ]
        foodSpawn = True
    ...
    pygame.draw.rect(
        playSurface, brown, pygame.Rect(foodPos[0], foodPos[1], delta, delta)
    )

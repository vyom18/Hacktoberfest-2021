...
keywords = ['select','create','drop', 'from','where','insert',' int',' varchar',' date','database','table','into','values','group by',
        ...
        'check','end','when','null','unique','identity','serial','view','default','distinct','exec','extract','having','join','outer',
        'left','inner','right','like','limit','or','procedure','rownum','top','update','set','truncate','union','ascii','char_length',
...
def SQLformat(sqlFile):
    try:
        ...
        with open (sqlFile, 'w') as output_sqlFile:
            ...
            print('\033[1m\033[92m[+] Executed :\033[0m File Changed to correct SQL format!\n\033[1m\033[92m[+] SUCCESS !\033[0m')
    except Exception as e:
        print('\033[1m\033[91m[-] Error:\033[0m',e,'\n\033[1m\033[91m[-] FAILURE !\033[0m')
...
___] |_\| |___    |    |__| |  \ |  | |  |  |   |  |___ |  \ 
    ...
    try:
        ...
        if '.sql' in sqlFile:
            ...
            print('\033[1m\033[91m[-] Error:\033[0m Please select SQL file only!\033[0m\n\033[1m\033[91m[-] FAILURE !\033[0m')
    except Exception as e:
        print('\033[1m\033[91m[-] Error:\033[0m',e,'\n\033[1m\033[91m[-] FAILURE !\033[0m')
        exit(0)
